...
optional_packages <- c("readxl", "gt", "gtExtras", "readr", "openxlsx", 
                       "janitor", "pdftools", "pandoc", "doconv", "emld", 
                       "markdown", "jsonlite", "digest", "stringr")
...
<div class="document-notes-container" style="margin: 20px 0; border: 2px solid #4CAF50; border-radius: 8px; overflow: hidden;">
  <div class="notes-header" style="background: linear-gradient(135deg, #667eea 0%%, #764ba2 100%%); color: white; padding: 10px 15px; font-weight: bold; cursor: pointer;" onclick="toggleNotes(\'%s\')">
    <span style="font-size: 16px;">📝 Questions & Observations for: %s</span>
    <span id="toggle-icon-%s" style="float: right;">▼</span>
  </div>
...
function exportAllNotes() {
  ...
  textareas.forEach(textarea => {
    if (textarea.value) {
      ...
      allNotes.push({
        document: header.replace('📝 Questions & Observations for: ', ''),
