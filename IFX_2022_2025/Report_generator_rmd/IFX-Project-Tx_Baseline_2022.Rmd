---
title: "<div style='background-color: #3EB489; padding: 10px;'><img src='logo.png' style='float:left; width:75px; height:35px; margin-right: 20px;'><span style='font-size: 26px'> IFX_2022 - Project - Tx_Baseline </span></div>"

author: "<div style='background-color: #3EB489; padding: 10px;'>PSS RFS DR RF PTE PRE</div>"
...
wd <- file.path("../02_Projects/01_Tx_Baseline")
