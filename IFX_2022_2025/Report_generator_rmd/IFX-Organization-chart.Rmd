---
title: "<div style='background-color: #3EB489; padding: 10px;'><img src='logo.png' style='float:left; width:75px; height:35px; margin-right: 20px;'><span style='font-size: 26px'> IFX - Org Chart - RFS </span></div>"
...
wd <- file.path("C:/Users/talluribhaga/Documents/My_IFX_activity/11_Org_chart/")
